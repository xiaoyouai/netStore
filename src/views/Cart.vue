                ...
                <ul class="cart-item-list">
                    <li v-for="item in cartList">
                        ...
                        <div class="cart-item-check">
                            <a href="javascipt:;" class="checkbox-btn item-check-btn" v-bind:class="{'check':parseInt(item.checked)}" @click="editCart('checked',item)">
                        ...
                        <div class="item-price">{{item.salePrice|mycurrency('￥')}}</div>
                        </div>
            ...
            <div class="cart-foot-inner">
                ...
                <div class="cart-foot-r">
                    <div class="item-total">
                        Item total: <span class="total-price">{{totalPrice|mycurrency('￥')}}</span>
                    </div>
                    <div class="btn-wrap">
...
import {currency} from './../util/currency'//价格过滤，格式化价格
export default{
    data(){
        return{
            cartList:[],
    ...
    computed: {
        ...
        checkedCount(){
            var i=0;
            this.cartList.forEach((item)=>{//计算被选中的数量
                if(item.checked=='1') i++;
            })
            return i;
        },
