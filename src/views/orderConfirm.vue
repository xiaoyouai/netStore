    ...
    <div class="container">
        ...
        <div class="item-list-wrap confirm-item-list-wrap">
            ...
            <ul class="cart-item-list">
                ...
                <div class="cart-tab-4">
                    <div class="item-price-total"> {{item.productNum*item.salePrice|mycurrency('￥')}}</div>
                </div>
                </li>
            </ul>
            </div>
        ...
        <div class="price-count-wrap">
            ...
            <ul>
                ...
                <span> {{subTotal|mycurrency('￥')}}</span>
                </li>
                <li>
                <span>Shipping:</span>
                <span> {{shipping|mycurrency('￥')}}</span>
                </li>
                <li>
                <span>Discount:</span>
        ...
        <div class="order-foot-wrap">
            ...
            <!-- <router-link class="btn btn--m btn--red">Proceed to payment</router-link> -->
            </div>
        </div>
        </div>
    </div>
  ...
  methods: {
         init(){
            axios.get('/users/cartList').then(response=>{
                ...
                this.cartList=json.result.filter(item=>item.checked==true);
       ...
       payMent(){
           axios.post('/users/payMent',{
               addressId:this.$route.query.addressId,orderTotal:this.orderTotal
               }).then(response=>{
