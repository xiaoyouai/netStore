...
<header class="header">
    ...
    <div class="navbar-right-container" style="display: flex;">
      <div class="navbar-menu-container">
        ...
        <span class="navbar-link" v-text="nickName" v-if="nickName"></span>
          <a href="javascript:void(0)" class="navbar-link" @click="loadingModalFlag=true" v-if="!nickName">Login</a>
        <a href="javascript:void(0)" class="navbar-link" v-if="nickName" @click="loginOut">Log out</a>
  ...
  <div class="md-modal modal-msg md-modal-transition" :class="{ 'md-show':loadingModalFlag}">
    <div class="md-modal-inner">
      <div class="md-top">
        <div class="md-title">Login in</div>
          <button class="md-close"@click="loadingModalFlag=false">Close</button>
      </div>
  ...
  <div class="md-overlay" v-if="loadingModalFlag" @click="loadingModalFlag=false"></div>
</header>
</template>
...
export default {
  ...
  methods: {
    checkLogin(){//利用cookie来验证登陆状态，从而做的刷新免登录
